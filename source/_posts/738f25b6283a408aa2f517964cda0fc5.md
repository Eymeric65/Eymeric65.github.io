...
It has been decided to use TestPyPi in order to test the library. The deyploment to TestPyPi is automatic for every new version push to the `main` branch of the repository thanks to GitHub action workflow.

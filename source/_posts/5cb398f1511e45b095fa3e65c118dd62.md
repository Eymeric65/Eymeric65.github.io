...
First of all I have tried to use Rlib in order to launch some Reinforcement learning experiment. I have been stopped by the complexity of writing a custom environment for Rlib.
The high abstraction of the reinforcement learning function also caused a lot of confusion. This lead to some time where not a lot of stuff worked. Since Rlib is also used by the RL-sindy team \[1-[@zolmanSINDyRLInterpretableEfficient2024](https://scholar.google.com/scholar?q=SINDy-RL%3A%20Interpretable%20and%20Efficient%20Model-Based%20Reinforcement%20Learning%2C%20Zolman)] I think I will need to

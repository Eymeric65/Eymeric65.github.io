...
The maintainer repository can be found on git [py-xl-sindy](https://github.com/Eymeric65/py-xl-sindy) and the actual binary are automatically push to PyPi at each release [py-xl-sindy](https://pypi.org/project/py-xl-sindy/)
